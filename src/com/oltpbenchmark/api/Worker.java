...
import com.oltpbenchmark.benchmarks.rest.RESTBenchmark;
import com.oltpbenchmark.benchmarks.wikipedia.WikipediaWorker;
import com.oltpbenchmark.benchmarks.wikirest.WikirestBenchmark;
...
public abstract class Worker implements Runnable {
    ...
    public Worker(BenchmarkModule benchmarkModule, int id) {
        ...
        this.wrkld = this.getBenchmarkModule().getWorkloadConfiguration();
        ...
        try {
            if (this.benchmarkModule instanceof RESTBenchmark || this.benchmarkModule instanceof WikirestBenchmark) {
                // XXX we do not need database connection incase of rest
                // connection, anilpacaci
                this.conn = null;
            } else {
