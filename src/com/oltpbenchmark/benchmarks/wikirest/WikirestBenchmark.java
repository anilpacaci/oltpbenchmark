...
public class WikirestBenchmark extends BenchmarkModule {
    private static final Logger LOG = Logger.getLogger(WikirestBenchmark.class);
    ...
    public WikirestBenchmark(WorkloadConfiguration workConf) {		
		super("wikirest", workConf, true);
	...
	protected List<Worker> makeWorkersImpl(boolean verbose) throws IOException {
	    LOG.info(String.format("Initializing %d %s using '%s' as the input trace file",
                               workConf.getTerminals(), WikirestWorker.class.getSimpleName(), this.traceInput));
